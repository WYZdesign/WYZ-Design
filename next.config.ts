      ...
      },
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://js.stripe.com https://www.googletagmanager.com https://connect.facebook.net https://www.clarity.ms https://analytics.tiktok.com",
            ...
            "connect-src 'self' https://api.resend.com https://api.stripe.com https://*.supabase.co wss://*.supabase.co https://o11y.sentry.io https://www.facebook.com https://analytics.tiktok.com https://www.clarity.ms",
