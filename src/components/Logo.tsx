...
/*
 src/components/Logo.tsx — single source of truth for the WYZ crown mark.
 Renders your real PNG at /public/wyz-crown.png. If the file is missing or fails
 to load, it falls back to an inline SVG crown — so you NEVER get a broken-image
 icon again. Use everywhere the logo belongs: <Logo size={44} showText />
*/
...
export default function Logo({
 ...
 <img src="/wyz-crown-square.png" alt="WYZ Design" width={size} height={h}
 style={{ objectFit: "contain", display: "block" }} onError={() => setBroken(true)} />
 )}
 {showText && (
