    ...
    <div className="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4" onClick={close}>
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={close} className="text-gray-400 hover:text-gray-600"><FiX className="w-5 h-5" /></button>
        </div>

        {albumMode ? (
          <div>
            <p className="text-sm text-gray-500 mb-4">Paste the folder path for this album:</p>
            ...
            <p className="text-xs text-gray-400 mb-4">Example paths:<br/>Pictures/Models (All)/ADRIENNE<br/>Pictures/Events/BONFIRE<br/>Graphics/Random Projects/WYZ Design</p>
        ...
        <button onClick={() => { setAlbumMode(!albumMode); setAlbumPath(""); }}
          className="mt-4 w-full py-2 text-sm text-gray-500 hover:text-[#DF3131] transition-colors">
