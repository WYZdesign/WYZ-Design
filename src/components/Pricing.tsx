...
const PLANS = [
  {
    ...
    features: ["(1) Two-Hour Photoshoot", "(1) Video Promo + Editing", "(1) Free Graphic Design (Logo, Cover Art, Flyer, Etc.)", "Marketing/Branding Strategy Consultations", "Zeal Rewards/Perks + Referral Discounts"],
  },
  {
    name: "Business Boost", price: "$500", period: "Every month", value: "$2,025 Value",
    features: ["(3) Graphic Designs (Logos, Flyer, Cover Art, Etc.)", "(2) Two-Hour Photoshoots", "(2) Promo Video Shoots (Up to 1 min.)", "Digital Printing Service (<$100)", "Marketing/Branding Strategy Consultations", "Zeal Rewards/Perks + Referral Discounts"],
  },
  {
    name: "Pro Plus", price: "$750", period: "Every month", value: "$1,425 Value",
    features: ["(3) Two-Hour Photoshoots", "(3) Graphic Designs (Logos, Flyer, Cover Art, Etc.)", "(3) Promo Video Shoots (Up to 1 min.)", "Digital Printing Service (<$250)", "Marketing/Branding Strategy Consultations", "Zeal Rewards/Perks + Referral Discounts"],
  },
  {
    name: "Ultimate Suite", price: "$1,000", period: "Every month", value: "$5,000+ Value",
    features: ["Professional Photoshoots (Unlimited)", "Graphic Designs (Unlimited)", "Video Promos + Editing (Unlimited)", "Digital Printing Service", "Web Design + Maintenance", "Marketing/Branding Strategy Consultations", "Event Planning Service (Optional)", "Zeal Rewards/Perks + Referral Discounts"],
  },
];
