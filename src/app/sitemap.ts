...
const PUBLIC_ROUTES: Array<{ path: string; priority?: number; changeFrequency?: "weekly" | "monthly" | "yearly" | "daily" }> = [
  ...
  { path: "/service-page/photoshoot", priority: 0.5, changeFrequency: "monthly" },
  { path: "/service-page/event-photography", priority: 0.5, changeFrequency: "monthly" },
  { path: "/service-page/photo-retouching", priority: 0.5, changeFrequency: "monthly" },
  { path: "/service-page/creative-consultation", priority: 0.5, changeFrequency: "monthly" },
