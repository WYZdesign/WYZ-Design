...
const POSTS = [
 ...
 { id: 10, title: "Custom Printing: From Concept to Creation", excerpt: "Taking a design from screen to physical product involves color profiles, material selection, and finishing techniques. This walkthrough covers the full custom printing pipeline.", date: "July 2, 2026", cat: "Printing", img: "https://images.unsplash.com/photo-1562731216-c3a4d99437d5?w=800&h=600&fit=crop", featured: false, readTime: "5 min" },
...
/>
 ...
 <img src={p.img} alt={p.title} className="blog-img w-full h-full object-cover dark:brightness-110 dark:contrast-110" />
 ...
 <div className="flex items-center gap-3 text-[#8F8F8F] dark:text-[#999] text-[12px] mb-3">
