...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Zeal Rewards | WYZ Design", description: "Earn Zeal for exploring the site and unlock real perks.", images: ["https://www.wyzdesign.com/wyz-og-image.png"] },
};
