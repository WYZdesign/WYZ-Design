...
function GalleryLightbox({ images, index, onClose, onPrev, onNext, onImageTap }: {
 ...
 <img src={images[index].src} alt={images[index].cat} width={900} height={600} className="max-h-[85vh] max-w-[90vw] object-contain select-none" draggable={false} onClick={(e) => { e.stopPropagation(); onImageTap(); }} />
