    ...
    <main className="pb-10 sm:pb-16 lg:pb-20 bg-white dark:bg-[#1C1C1E] min-h-screen">
      <ScrollReveal animation="fadeUp">
        <div className="relative max-w-2xl mx-auto px-6 pt-20 sm:pt-28 lg:pt-32">
          ...
          <h1 className="text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[3rem] font-heading font-black text-[#333] dark:text-[#e0e0e0] tracking-[0.08em] text-center mb-6 sm:mb-8" style={{ lineHeight: 0.9 }}>CONTACT US</h1>
          </TextMaskReveal>
          </div>
