...
const CLIENT_LOGOS = shuffleArray([
 ...
 { name: "Unamed", img: "/images/client-logos/unnamed (1).png" },
 { name: "Win E", img: "/images/client-logos/Win E Logo (no background).png" },
 { name: "Client", img: "/images/client-logos/18700C58-DA56-4EDF-B21F-203F68D3FBCB.jpeg" },
 { name: "Baderbrau", img: "/images/client-logos/Baderbrau-Logo-570x558.png" },
 { name: "BDSM", img: "/images/client-logos/BDSM Logo Draft copy.jpg" },
 { name: "Hairpin", img: "/images/client-logos/Copy+of+Hairpin_Pins.png" },
 { name: "Creator", img: "/images/client-logos/Creator.png" },
 { name: "Download", img: "/images/client-logos/download.png" },
 { name: "Fun Timez", img: "/images/client-logos/Fun Timez Logo.jpg" },
 { name: "Logo", img: "/images/client-logos/I-eDHeE3.png" },
 { name: "Cocktails", img: "/images/client-logos/logo cocktails.jpg" },
 { name: "Logo2", img: "/images/client-logos/logo-2.png" },
 ...
 { name: "Enticing Cafe", img: "/images/client-logos/enticing-cafe.jpg" },
 { name: "AM", img: "/images/client-logos/am.jpg" },
 { name: "Diamond Kiss", img: "/images/client-logos/diamond-kiss.jpg" },
 { name: "AP", img: "/images/client-logos/ap.jpg" },
 { name: "Photo-Bombed", img: "/images/client-logos/photo-bombed.png" },
 { name: "Justy", img: "/images/client-logos/justy.png" },
 { name: "JR3Y", img: "/images/client-logos/jr3y.jpg" },
 { name: "Vanity J", img: "/images/client-logos/vanity-j.jpg" },
 { name: "Live Life Fearless", img: "/images/client-logos/live-life-fearless.jpg" },
 { name: "LaBelleza", img: "/images/client-logos/labelleza.jpg" },
 { name: "K&G", img: "/images/client-logos/k-and-g.jpg" },
 { name: "Monkey Mug", img: "/images/client-logos/monkey-mug.jpg" },
 { name: "PornEstrella", img: "/images/client-logos/pornestrella.png" },
...
export default function HomePage() {
 ...
 `}</style>
    ...
    style={{ opacity: heroVis ? 1 : 0, transform: heroVis ? "none" : "translateY(24px)", transition: "all 0.8s ease-out" }}>
     ...
     <MagneticElement tag="div" strength={0.25}>
     <Link href="/contact"
     className="inline-block px-6 sm:px-8 py-3 sm:py-4 font-heading font-bold tracking-[0.15em] uppercase text-[12px] sm:text-[15px] text-center bg-[#DF3131] text-white hover:bg-[#B82020] transition-all">
     START A PROJECT
     </Link>
     </MagneticElement>
    </div>
