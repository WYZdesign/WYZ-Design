...
<h1 className="text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[4rem] font-heading font-black text-white tracking-[0.12em] mb-4 sm:mb-6" style={{ lineHeight: 1 }}>
  CREATIVE <span className="text-[#DF3131]">SERVICES</span>
  </h1>
  <p className="text-white/70 text-[16px] sm:text-base leading-relaxed mb-2 sm:mb-3 max-w-md mx-auto lg:mx-0">
