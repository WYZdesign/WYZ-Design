...
export default function MyAccountPage() {
 return (
 <Suspense fallback={<div className="min-h-screen bg-white dark:bg-[#232326] pb-20"><div className="max-w-md mx-auto px-6 text-center py-20"><p className="text-[#888] dark:text-white/50">Loading...</p></div></div>}>
 <MyAccount />
 </Suspense>
 );
}
...
function MyAccount() {
 ...
 className="w-full flex items-center justify-center gap-3 bg-white dark:bg-[#2b2b2e] text-[#333] dark:text-white border-2 border-[#E2E2E2] dark:border-[#444] py-3 font-bold text-sm hover:border-[#333] dark:hover:border-white transition-colors">
 ...
 <form onSubmit={handleSignIn} className="space-y-4">
  ...
  <input type="email" required value={email} onChange={e => setEmail(e.target.value)} className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none" placeholder="your@email.com" />
  </div>
  <div>
  ...
  <input type="password" value={password} onChange={e => setPassword(e.target.value)} className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none" placeholder="Leave blank for magic link" />
  </div>
 ...
 <form onSubmit={handleRegister} className="space-y-4">
  ...
  <input type="text" required value={name} onChange={e => setName(e.target.value)} className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none" placeholder="Your name" />
  </div>
  <div>
  <label className="block text-sm font-heading font-bold tracking-[0.1em] uppercase text-[#333] dark:text-white mb-1">Email</label>
  <input type="email" required value={email} onChange={e => setEmail(e.target.value)} className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none" placeholder="your@email.com" />
...
function AuthenticatedDashboard({ session, update, signOut }: any) {
 ...
 return (
 <main className="min-h-screen bg-[#F5F5F3] dark:bg-[#2b2b2e] pb-20">
 ...
 {/* Profile Card */}
  <div className="bg-white dark:bg-[#2b2b2e] border border-gray-200 dark:border-[#444] p-8 mb-6">
 ...
 {/* Bug Report */}
  <div className="bg-white dark:bg-[#2b2b2e] border border-gray-200 dark:border-[#444] p-6 mb-6">
 ...
 <div className="mt-5 space-y-4">
  ...
  <select value={bugCat} onChange={e => { setBugCat(e.target.value); setBugChecks([]); }} className="w-full border border-gray-300 dark:border-[#444] px-4 py-2.5 text-[14px] text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none">
  ...
  className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[14px] text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none resize-none" />
  </div>
...
function Field({ label, value, onChange, textarea, placeholder }: { label: string; value: string; onChange: (v: string) => void; textarea?: boolean; placeholder?: string }) {
 ...
 className="w-full border border-gray-300 dark:border-[#444] px-4 py-3 text-[14px] text-[#333] dark:text-white bg-white dark:bg-[#2b2b2e] focus:border-[#DF3131] focus:outline-none" />
 )}
 </div>
 );
}
