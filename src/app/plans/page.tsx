...
<h1 className="text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[4rem] font-heading font-black text-[#333] dark:text-white tracking-[0.12em] mb-4 sm:mb-6" style={{ lineHeight: 1 }}>
 CHOOSE YOUR <span className="text-[#DF3131]">PRICING</span> PLAN
 </h1>
 <p className="text-[#666] dark:text-white/70 text-[16px] sm:text-base leading-relaxed mb-2 sm:mb-3 max-w-md mx-auto">
