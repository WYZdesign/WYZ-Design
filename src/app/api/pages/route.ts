...
<section class="wyz-section wyz-bg-offwhite"><div class="wyz-container"><div class="wyz-cta-grid"><div class="wyz-card"><h4 class="wyz-card-title">GRAPHIC DESIGNS</h4><p class="wyz-card-desc">Elevate your brand with expert graphic design that captivates and sets you apart. Visit the graphic design page to browse our portfolio.</p><a href="/designs" class="wyz-link wyz-link-arrow">View Gallery</a></div><div class="wyz-card"><h4 class="wyz-card-title">PHOTOGRAPHY</h4><p class="wyz-card-desc">Engage and inspire with stunning photography that captures your brand's essence — from product shots to lifestyle imagery. Visit our photography page to view albums.</p><a href="/photography" class="wyz-link wyz-link-arrow">View Albums</a></div><div class="wyz-card"><h4 class="wyz-card-title">EVENT RECAPS</h4><p class="wyz-card-desc">Relive the magic with our captivating event recaps. We capture every moment to tell your story with power and authenticity. Visit our event recaps page to see the magic for yourself.</p><a href="/events" class="wyz-link wyz-link-arrow">View Recaps</a></div></div></div></section>
...
export async function POST(req: Request) {
  ...
  const { ok, remaining } = rateLimit(`pages:${ip}`, 10, 60_000);
  if (!ok) {
